        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                if nextPosition==self.corners[0]:
                    ...
                    nextState=(nextPosition,(state[1][0],True,state[1][2],state[1][3]))
                elif nextPosition==self.corners[2]:
                    nextState=(nextPosition,(state[1][0],state[1][1],True,state[1][3]))
                elif nextPosition==self.corners[3]:
                    nextState=(nextPosition,(state[1][0],state[1][1],state[1][2],True))
                else:
